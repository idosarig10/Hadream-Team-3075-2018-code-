...
public class Constants
{
	...
	public static final PIDvalue rightTurnPID = new PIDvalue(6, 2, 0);
	public static final PIDvalue leftTurnPID = new PIDvalue(6, 2, 0);
...
//	public static final PIDvalue leftPositionPID = new PIDvalue(7.5, 1, 0.1);
	...
	public static final PIDvalue rightPositionPID = new PIDvalue(4, 1, 0);
	public static final PIDvalue leftPositionPID = new PIDvalue(4, 1, 0);
	...
	public static final double turnAngleTolerance = 2;
