...
public class Constants
{
	...
	public static final double rightTurnMaxA = .5;
	public static final double leftTurnMaxA = .5;
	...
	public static final MPValue rightTurnMP = new MPValue(rightTurnPID, 1 / rightTurnMaxV, 0.5);
	public static final MPValue leftTurnMP = new MPValue(leftTurnPID, 1 / leftTurnMaxV, 0.5);
	
	public static final double turnAngleTolerance = 1;
